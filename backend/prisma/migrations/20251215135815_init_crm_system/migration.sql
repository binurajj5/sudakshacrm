-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'MANAGER', 'SALES', 'SUPPORT', 'USER');

-- CreateEnum
CREATE TYPE "UserStatus" AS ENUM ('ACTIVE', 'INACTIVE', 'SUSPENDED');

-- CreateEnum
CREATE TYPE "ContactType" AS ENUM ('STUDENT', 'CORPORATE', 'INSTITUTION', 'INDIVIDUAL');

-- CreateEnum
CREATE TYPE "ContactStatus" AS ENUM ('LEAD', 'PROSPECT', 'CUSTOMER', 'INACTIVE');

-- CreateEnum
CREATE TYPE "CompanyType" AS ENUM ('ENTERPRISE', 'SMB', 'STARTUP', 'EDUCATION');
